...
import com.larkmt.cn.core.util.FileUtil;
...
public class TriggerCallbackThread {
    ...
    public static void pushCallBack(HandleCallbackParam callback) {
        ...
        logger.debug(">>>>>>>>>>> LarkMidTable, push callback request, logId:{}", callback.getLogId());
    }
    ...
    public void start() {
        ...
        triggerCallbackThread.setName("LarkMidTable, executor TriggerCallbackThread");
    ...
    private static String failCallbackFileName = failCallbackFilePath.concat("LarkMidTable-callback-{x}").concat(".log");
