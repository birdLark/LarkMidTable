...
import com.larkmidtable.rpc.remoting.net.impl.netty_http.client.NettyHttpClient;
...
public class JobScheduler {
    ...
    public void init() throws Exception {
        ...
        logger.info(">>>>>>>>> init web admin success.");
    }
