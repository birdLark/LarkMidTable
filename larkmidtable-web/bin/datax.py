...
DATAX_HOME = ""
# DATAX_HOME = "E:\\study\\ideaProjects\\Datax\\datax"
...
if __name__ == "__main__":
    ...
    printCopyright()
    DATAX_HOME = sys.argv[2]
    print '-------------'
    print 'DATAX_HOME path: '+DATAX_HOME
    if isWindows():
    ...
    # 需要传 datax的位置  日志的存储位置
    # args[0]:  json文件的位置    args[1]:  datax的位置  args[2]: 日志的存储位置
    ...
    startCommand = startCommand +" > "+ args[2]
    print startCommand
