<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="描述" align="center" width="120">
        <template slot-scope="scope">{{ scope.row.projectName }}</template>
      </el-table-column>
      <el-table-column label="UDF的子路径" align="center" width="120">
        ...
        <template slot-scope="{row}">
          ...
          <el-dropdown trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item divided @click.native="handlerUpdate(row)">下载</el-dropdown-item>
