        ...
        <template slot-scope="{row}">
          ...
          <el-dropdown trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item @click.native="handlerExecute(row)">开启任务</el-dropdown-item>
              <el-dropdown-item @click.native="handlerViewLog(row)">停止任务</el-dropdown-item>
              <el-dropdown-item divided @click.native="handlerUpdate(row)">查看日志</el-dropdown-item>
              <el-dropdown-item @click.native="handlerDelete(row)">运行环境参数</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </template>
      </el-table-column>
