package com.larkmt.cn.core.executor;

import com.larkmt.cn.core.biz.AdminBiz;
import com.larkmt.cn.core.biz.ExecutorBiz;
import com.larkmt.cn.core.biz.client.AdminBizClient;
...
import com.larkmt.cn.core.thread.*;
import com.larkmt.cn.rpc.registry.ServiceRegistry;
import com.larkmt.cn.rpc.remoting.net.impl.netty_http.server.NettyHttpServer;
import com.larkmt.cn.rpc.remoting.provider.XxlRpcProviderFactory;
...
import com.larkmt.cn.rpc.util.NetUtil;
import com.larkmt.cn.core.thread.ExecutorRegistryThread;
import com.larkmt.cn.core.thread.JobLogFileCleanThread;
import com.larkmt.cn.core.thread.JobThread;
import com.larkmt.cn.core.thread.ProcessCallbackThread;
import com.larkmt.cn.core.thread.TriggerCallbackThread;
...
public class JobExecutor {
            ...
            for (Map.Entry<Integer, JobThread> item : jobThreadRepository.entrySet()) {
                ...
                if (oldJobThread != null) {
                    try {
                        ...
                        logger.error(">>>>>>>>>>> LarkMidTable, JobThread destroy(join) error, jobId:{}", item.getKey(), e);
                    }
                }
            }
    ...
    public static IJobHandler registJobHandler(String name, IJobHandler jobHandler) {
        logger.info(">>>>>>>>>>> LarkMidTable register jobhandler success, name:{}, jobHandler:{}", name, jobHandler);
    ...
    public static JobThread registJobThread(int jobId, IJobHandler handler, String removeOldReason) {
        ...
        newJobThread.start();
        logger.info(">>>>>>>>>>> LarkMidTable regist JobThread success, jobId:{}, handler:{}", new Object[]{jobId, handler});
