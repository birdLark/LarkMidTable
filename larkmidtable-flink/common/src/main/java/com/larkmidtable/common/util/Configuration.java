package com.larkmidtable.common.util;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.larkmidtable.common.exception.CommonErrorCode;
...
public class Configuration {
	...
	public static Configuration from(String json) {
		...
		try {
			...
			throw LarkMidTableException.asLarkMidTableException(CommonErrorCode.CONFIG_ERROR,
					e);
		}
	...
	public static Configuration from(File file) {
		try {
			...
			throw LarkMidTableException.asLarkMidTableException(
	...
	public String getNecessaryValue(String key, ErrorCode errorCode) {
		...
		if (StringUtils.isBlank(value)) {
			throw LarkMidTableException.asLarkMidTableException(errorCode,
	...
	private void setObject(final String path, final Object object) {
		...
		throw LarkMidTableException.asLarkMidTableException(CommonErrorCode.RUNTIME_ERROR,
